...
@endif
{!! Form::open(array('url' => 'admin/rewards', 'files'=>'true', 'class' => 'form-horizontal'))!!}
...
<div class="form-group">                    
    ...
    {!! Form::file('image', null, array('placeholder' => 'Featured Image', 'required'=>'required', 'accept' => 'image/*', 'multiple'=>'false' )) !!}
    </span>
    </div>
</div>
