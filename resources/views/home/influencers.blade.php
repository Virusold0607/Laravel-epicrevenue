    ...
    <div class="main campaigns influencer">
        <div class="home-banner campaigns-header">
            ...
            <div class="home-body">
                <div class="container">
                    <h1>INFLUENCERS</h1>
                    <div class="influencer-header-graphic"><img src="/images/influencer1.png" class="img-responsive"></div>
                </div>
            </div>
        </div>
        <div class="influencer-panel">
            ...
            <div class="influencer-maximize">
                <div class="container">
                    <h2 class="page-title-3">Are	you	ready	to	maximize  </br> your	revenue?</h2>
                    <p>Trusted	by	more	than	10	million	accounts</p>
                </div>
            </div>
            <div class="influencer-feature text-center">
                <h3>FEATURES</h3>
                <div class="container">
                    <div class="row">
