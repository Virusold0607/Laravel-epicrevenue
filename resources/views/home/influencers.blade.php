    ...
    <div class="container">
        <div class="influencers-page-content text-center">
            <div class="row text-center">
                <div class="col-sm-4">
                    <div class="glyphicon-cirlce"><span class="fa fa-bar-chart"></span></div>
                ...
                <div class="col-sm-4">
                    <div class="glyphicon-cirlce"><span class="fa fa-lock"></span></div>
                ...
                <div class="col-sm-4">
                    <div class="glyphicon-cirlce"><span class="fa fa-cog"></span></div>
                    <h4>Optimization</h4>
                ...
                <div class="col-sm-4">
                    <div class="glyphicon-cirlce"><span class="fa fa-usd"></span></div>
                ...
                <div class="col-sm-4">
                    <div class="glyphicon-cirlce"><span class="fa fa-lightbulb-o"></span></div>
