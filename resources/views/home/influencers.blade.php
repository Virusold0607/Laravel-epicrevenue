    ...
    <div class="container text-center">
        ...
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
                <h2 class="tab-title">Why You Should Apply To Our Network?</h2>
            ...
            <div id="menu1" class="tab-pane fade">
                <h2 class="tab-title">Reporting</h2>
            ...
            <div id="menu2" class="tab-pane fade">
                <h2 class="tab-title">Innovative Landing pages</h2>
            ...
            <div id="menu3" class="tab-pane fade">
                <h2 class="tab-title">Creatives</h2>
            ...
            <div id="menu6" class="tab-pane fade">
                <h2 class="tab-title">Optimization</h2>
            ...
            <div id="menu7" class="tab-pane fade">
                <h2 class="tab-title">Payments are sent every Friday!</h2>
