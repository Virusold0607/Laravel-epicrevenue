...
@section('body')
    <div class="hero text-center py-6">
        <div class="container">
            <h1 class="fw-800">Are you an Influencer? Affiliate</h1>
    ...
    <div class="container">
        <div class="influencers-page-content text-center py-6">
            <div class="row text-center">
                ...
                <div class="col-sm-4">
                    <div class="ir-icon"><img class="img-responsive" src="/images/home/icons/icon-2.png" alt="Advanced Security"></div>
                ...
                <div class="col-sm-4">
                    <div class="ir-icon"><img class="img-responsive" src="/images/home/icons/icon-3.png" alt="Optimization"></div>
                    <h4>Features</h4>
                ...
                <div class="col-sm-4">
                    <div class="ir-icon"><img class="img-responsive" src="/images/home/icons/icon-4.png" alt="Optimization"></div>
                    <h4>Optimization</h4>
                ...
                <div class="col-sm-4">
                    <div class="ir-icon"><img class="img-responsive" src="/images/home/icons/icon-5.png" alt="Weekly Payments!"></div>
                ...
                <div class="col-sm-4">
                    <div class="ir-icon"><img class="img-responsive" src="/images/home/icons/icon-6.png" alt="Creatives & Landing Pages"></div>
